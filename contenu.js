...
const CONTENU_SITE = {
  ...
  produits: [
    ...
    {
      nom: "L'Arc du Riad Majestueux",
      description: "Ce tableau mural sublime l'élégance d'un patio marocain traditionnel, mettant en valeur une arche ornée de zelliges bleus et dorés. La composition, enrichie de lanternes suspendues et de coussins colorés, invite à la détente et à la contemplation dans une ambiance chaleureuse.",
      categorie: "paysages",
      style: "traditionnel",
      environnement: "riad",
      image: "images/produit-7.jpg",
      imageFallback: "🎨",
      prix: "A partir de 70 MAD",
      badge: "Nouveau",
      materiauRecommande: "Toile Canvas",
      montageRecommande: "Cadre Américain",
      couleurs: ["Beige", "Bleu Majorelle", "Doré", "Vert", "Terracotta"],
      ambiance: "Chaleureuse, traditionnelle et apaisante",
    },
    {
